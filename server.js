...
#game:not(.hide){min-height:calc(100dvh - 56px);display:grid;place-items:center}.statusStack .pill{margin-bottom:14px}.statusStack h2{margin-bottom:14px}.statusStack .sub{margin-top:0}.questionPanel{display:block;text-align:left;padding:32px}@media(min-width:861px){body.playing .wrap.narrow{width:min(100% - 56px,1100px);max-width:1100px}body.playing #game{min-height:calc(100dvh - 56px)}body.playing #game>.card,body.playing #game>.panel{width:100%;min-height:min(70vh,720px)}body.playing .questionPanel{padding:52px}body.playing .questionPanel h2{font-size:clamp(38px,3.4vw,58px);line-height:1.14}body.playing .answerInput{min-height:68px;font-size:24px}body.playing .questionPanel .btn{font-size:17px;padding:15px 24px}body.playing .card.screen h2{font-size:clamp(40px,3.6vw,60px)}body.playing .card.screen .sub{font-size:24px}}.questionPanel .pill{background:var(--ink);color:#FFFFFF;border-color:var(--ink)}.questionPanel h2{margin-top:20px;margin-bottom:18px;line-height:1.25}.questionPanel .muted{margin-bottom:0}.guessLabel{margin-top:34px}.answerInput{min-height:56px;margin-top:0;margin-bottom:20px;font-size:18px;background:#FFFFFF}.answerHint{margin-top:22px;font-size:14px;line-height:1.45}#joinBtn{margin-top:16px}
