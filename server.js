...
input,textarea{border:1px solid #D2D2D7;background:#FFFFFF;border-radius:16px;padding:16px 17px;outline:none;transition:border-color .15s,box-shadow .15s,background .15s}input:focus,textarea:focus{border-color:#0071E3;box-shadow:0 0 0 4px rgba(0,113,227,.14);background:#FFFFFF}input::placeholder,textarea::placeholder{color:#86868B}label{font-size:14px;font-weight:650;color:#1D1D1F;margin:18px 0 8px}.answerBox{font-size:32px;background:#F5F5F7}
...
@media(max-width:860px){.wrap{padding:18px}h1{font-size:42px}.card,.panel,.item{padding:22px;border-radius:22px}}
</style>
</head>`;
}
...
<div class="wrap narrow">
  <section id="intro" class="hero">${brand("Schätzquiz")}<h1>Wer liegt am nächsten?</h1><p class="sub">Gebt euer zugeordnetes Symbol ein und beantwortet die Schätzfragen in eurem Tempo.</p></section>
