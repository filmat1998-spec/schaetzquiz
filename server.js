...
.podium{display:grid;grid-template-columns:1fr 1.18fr 1fr;gap:18px;align-items:end;margin-top:22px;width:100%}.podiumCard{border:1px solid #AEAEB2;border-radius:22px;padding:30px;text-align:center;background:#D1D1D6;box-shadow:var(--shadow);display:flex;flex-direction:column;align-items:center;justify-content:center}.podiumCard.first{min-height:340px;background:#FFFFFF;color:var(--ink);border-color:var(--line)}.podiumCard.first h2,.podiumCard.first .podiumName{color:#FFFFFF}.podiumCard.second{min-height:280px}.podiumCard.third{min-height:240px}.podiumCard.second .medal,.podiumCard.third .medal{font-size:58px}.podiumCard.second h2,.podiumCard.third h2{font-size:24px}.podiumCard.second .podiumName,.podiumCard.third .podiumName{font-size:clamp(28px,4vw,58px)}.medal{font-size:70px;filter:saturate(.92)}.podiumName{font-size:clamp(32px,5vw,72px);font-weight:900;line-height:1}.reveal{display:grid;place-items:center;min-height:380px;text-align:center}.reveal .medal{font-size:120px}.reveal .podiumName{font-size:clamp(48px,8vw,110px);font-weight:780}
