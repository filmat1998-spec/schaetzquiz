...
.statusStack .pill{margin-bottom:14px}.statusStack h2{margin-bottom:14px}.statusStack .sub{margin-top:0}.questionPanel{display:block;text-align:left;padding:32px}.questionPanel h2{margin-top:20px;margin-bottom:18px;line-height:1.25}.questionPanel .muted{margin-bottom:0}.guessLabel{margin-top:34px}.answerInput{min-height:56px;margin-top:0;margin-bottom:20px;font-size:18px;background:#FFFFFF}.answerHint{margin-top:22px;font-size:14px;line-height:1.45}#joinBtn{margin-top:16px}
.distRow{display:grid;grid-template-columns:190px 140px 1fr;gap:14px;align-items:center;margin:12px 0}.distValue{text-align:right;font-variant-numeric:tabular-nums;white-space:nowrap}.barTrack{height:30px;border:1px solid var(--line);border-radius:999px;background:var(--gray-button);overflow:hidden}.barFill{height:100%;min-width:18px;max-width:100%;border-radius:999px}.barFill.red{background:var(--red)}.barFill.green{background:var(--green)}.solutionRow{background:transparent;border-color:transparent}.solutionLabel{font-weight:900;color:var(--green-dark)}.answerCard{display:inline-flex;flex-direction:column;align-items:center;gap:6px;margin:10px auto 20px;padding:18px 30px;border:1px solid #B7E7C4;border-radius:22px;background:#F2FFF5}.answerCardLabel{font-size:14px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:var(--green-dark)}.answerCardValue{font-size:clamp(34px,4vw,58px);line-height:1;font-weight:780;color:var(--ink)}
...
.displayWrap{max-width:1320px;min-height:100vh;padding:30px;display:flex;flex-direction:column}.displayWrap .hero{position:fixed;top:22px;left:24px;z-index:15;padding:0}.displayWrap .brand{font-size:13px}#display{flex:1;display:grid;place-items:center;min-height:0}.displayCard{width:100%;min-height:min(78vh,820px);padding:clamp(42px,5vw,76px);border-radius:30px}.displayCard>div{width:min(1040px,100%);margin:0 auto}.displayWrap h1{font-size:clamp(58px,7vw,108px);line-height:1.02;margin:20px 0 18px}.displayWrap h2{font-size:clamp(34px,4vw,58px)}.displayWrap .sub{max-width:920px;font-size:clamp(21px,2vw,30px)}.displayWrap .huge{font-size:clamp(56px,6vw,92px)}.displayWrap .qrLarge{width:min(520px,58vw);border-radius:28px;padding:18px}.displayWrap .teamChips{gap:14px;margin:24px 0}.displayWrap .teamChip{font-size:22px;padding:14px 20px}.displayWrap .btn{font-size:20px;padding:17px 28px}.displayActions{justify-content:center;margin-top:32px;gap:16px}.displayWrap .table{font-size:22px;margin-top:28px}.displayWrap .table th,.displayWrap .table td{padding:15px 12px}.displayWrap .distRow{grid-template-columns:240px 170px 1fr;gap:20px;font-size:22px;margin:18px 0}.displayWrap .barTrack{height:40px}.displayWrap .item{padding:30px}.displayWrap .resultQuestion{max-width:1040px;margin-left:auto;margin-right:auto;font-size:clamp(40px,4.6vw,72px);line-height:1.12}.displayWrap .medal{font-size:92px}.displayWrap .reveal{min-height:520px}.displayWrap .reveal .medal{font-size:160px}.displayWrap .reveal .podiumName{font-size:clamp(72px,9vw,140px)}.displayWrap .podiumName{font-size:clamp(42px,5vw,82px)}.displayWrap .podium{gap:26px}.displayWrap .podiumCard{padding:40px 30px;border-radius:28px}.displayWrap .podiumCard.first{min-height:370px}.displayWrap .podiumCard.second{min-height:300px}.displayWrap .podiumCard.third{min-height:260px}
