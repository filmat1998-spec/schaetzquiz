...
<div class="wrap narrow">
  ...
  <section id="join" class="card"><h2>Mitspielen</h2><label for="teamLabel">Teamname / Symbol eingeben</label><input id="teamLabel" maxlength="80" autocomplete="off" placeholder="z. B. Team Sonne oder Symbol Stern"><button class="btn alt" id="joinBtn">Beitreten</button></section>
