...
input,textarea{border:1px solid #D2D2D7;background:#FFFFFF;border-radius:16px;padding:16px 17px;outline:none;transition:border-color .15s,box-shadow .15s,background .15s}input:focus,textarea:focus{border-color:#0071E3;box-shadow:0 0 0 4px rgba(0,113,227,.14);background:#FFFFFF}input::placeholder,textarea::placeholder{color:#86868B}label{font-size:14px;font-weight:650;color:#1D1D1F;margin:18px 0 8px}.answerBox{font-size:32px;background:#F5F5F7}#joinBtn{margin-top:16px}.questionPanel{display:block;text-align:left}.questionPanel h2{margin-top:18px}.guessLabel{margin-top:28px}.answerInput{margin-top:0;margin-bottom:18px;font-size:18px;background:#FFFFFF}.answerHint{margin-top:18px;font-size:14px}
