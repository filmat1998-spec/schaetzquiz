...
#game:not(.hide){min-height:calc(100dvh - 56px);display:grid;place-items:center}.statusStack .pill{margin-bottom:14px}.statusStack h2{margin-bottom:14px}.statusStack .sub{margin-top:0}.questionPanel{display:block;text-align:left;padding:32px}@media(min-width:861px){body.playing .wrap.narrow{max-width:980px}body.playing .questionPanel{padding:42px}body.playing .questionPanel h2{font-size:clamp(34px,3vw,48px);line-height:1.16}body.playing .answerInput{min-height:64px;font-size:22px}body.playing .questionPanel .btn{font-size:16px;padding:14px 22px}body.playing .card.screen h2{font-size:clamp(34px,3vw,48px)}body.playing .card.screen .sub{font-size:22px}}.questionPanel .pill{background:var(--ink);color:#FFFFFF;border-color:var(--ink)}.questionPanel h2{margin-top:20px;margin-bottom:18px;line-height:1.25}.questionPanel .muted{margin-bottom:0}.guessLabel{margin-top:34px}.answerInput{min-height:56px;margin-top:0;margin-bottom:20px;font-size:18px;background:#FFFFFF}.answerHint{margin-top:22px;font-size:14px;line-height:1.45}#joinBtn{margin-top:16px}
