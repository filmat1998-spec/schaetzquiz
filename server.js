...
input,textarea{border:1px solid #D2D2D7;background:#FFFFFF;border-radius:16px;padding:16px 17px;outline:none;transition:border-color .15s,box-shadow .15s,background .15s}input:focus,textarea:focus{border-color:#0071E3;box-shadow:0 0 0 4px rgba(0,113,227,.14);background:#FFFFFF}input::placeholder,textarea::placeholder{color:#86868B}label{font-size:14px;font-weight:650;color:#1D1D1F;margin:18px 0 8px}.answerBox{font-size:32px;background:#F5F5F7}#joinBtn{margin-top:16px}
...
<div class="wrap narrow">
  ...
  <section id="join" class="card"><h2>Mitspielen</h2><label for="teamLabel">Teamname / Symbol eingeben</label><input id="teamLabel" maxlength="80" autocomplete="off" placeholder="z. B. Löwe oder Giraffe"><button class="btn alt" id="joinBtn">Beitreten</button></section>
