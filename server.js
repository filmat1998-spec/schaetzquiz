...
<div class="wrap narrow">
  ...
  <section id="join" class="card"><h2>Euer Team</h2><input id="teamLabel" maxlength="80" autocomplete="off" placeholder="z. B. Löwe oder Giraffe"><button class="btn alt" id="joinBtn">Los geht's</button></section>
