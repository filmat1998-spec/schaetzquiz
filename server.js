...
#game:not(.hide){min-height:calc(100dvh - 56px);display:grid;place-items:center}.statusStack .pill{margin-bottom:14px}.statusStack h2{margin-bottom:14px}.statusStack .sub{margin-top:0}.questionPanel{display:block;text-align:left;padding:32px}.questionPanel .pill{background:var(--ink);color:#FFFFFF;border-color:var(--ink)}.questionPanel h2{margin-top:20px;margin-bottom:18px;line-height:1.25}.questionPanel .muted{margin-bottom:0}.guessLabel{margin-top:34px}.answerInput{min-height:56px;margin-top:0;margin-bottom:20px;font-size:18px;background:#FFFFFF}.answerHint{margin-top:22px;font-size:14px;line-height:1.45}#joinBtn{margin-top:16px}
