...
function scoreMap() {
  ...
  state.questions.forEach(q => {
    const rows = getQuestionDistribution(q.id);
    ...
    rows.forEach(row => {
      ...
      const points = maxDiff === minDiff
        ? 100
        : Math.round(100 * (maxDiff - row.diff) / (maxDiff - minDiff));

      map[row.teamKey].score += points;
...
.podium{display:grid;grid-template-columns:1fr 1.18fr 1fr;gap:18px;align-items:end;margin-top:22px;width:100%}.podiumCard{border:1px solid #AEAEB2;border-radius:22px;padding:30px;text-align:center;background:#D1D1D6;box-shadow:var(--shadow);display:flex;flex-direction:column;align-items:center;justify-content:center}.podiumCard.first{min-height:340px;background:var(--ink);color:#FFFFFF;border-color:var(--ink)}.podiumCard.first h2,.podiumCard.first .podiumName,.podiumCard.first .big{color:#FFFFFF}.podiumCard.second{min-height:280px}.podiumCard.third{min-height:240px}.podiumCard.second .medal,.podiumCard.third .medal{font-size:58px}.podiumCard.second h2,.podiumCard.third h2{font-size:24px}.podiumCard.second .podiumName,.podiumCard.third .podiumName{font-size:clamp(28px,4vw,58px)}.medal{font-size:70px;filter:saturate(.92)}.podiumName{font-size:clamp(32px,5vw,72px);font-weight:900;line-height:1}.reveal{display:grid;place-items:center;min-height:380px;text-align:center}.reveal .medal{font-size:120px}.reveal .podiumName{font-size:clamp(48px,8vw,110px);font-weight:780}
.displayWrap{width:100%;max-width:none;min-height:100vh;padding:32px clamp(28px,4vw,64px);display:flex;flex-direction:column}.displayWrap .hero{position:fixed;top:22px;left:24px;z-index:15;padding:0}.displayWrap .brand{font-size:13px}#display{width:100%;flex:1;display:grid;place-items:center;min-height:0}.displayCard{width:min(100%,1280px);min-height:calc(100vh - 150px);padding:clamp(42px,5vw,76px);padding-bottom:clamp(118px,11vh,160px);border-radius:30px;position:relative}.displayCard>div{width:min(1040px,100%);margin:0 auto;display:flex;flex-direction:column;align-items:center}.displayWrap h1{font-size:clamp(58px,7vw,108px);line-height:1.02;margin:0 0 24px}.displayWrap h2{font-size:clamp(34px,4vw,58px)}.displayWrap .sub{max-width:920px;font-size:clamp(21px,2vw,30px);margin-top:0;margin-bottom:30px}.displayWrap .huge{font-size:clamp(56px,6vw,92px);margin:18px 0 34px}.displayWrap .qrLarge{width:min(520px,58vw);border-radius:28px;padding:18px;margin:6px 0 30px}.displayWrap .teamChips{gap:14px;margin:8px 0 36px}.displayWrap .teamChip{font-size:22px;padding:14px 20px}.displayWrap .btn{font-size:20px;padding:17px 28px}.displayActions{position:absolute;left:50%;bottom:clamp(34px,4.5vh,58px);transform:translateX(-50%);justify-content:center;gap:16px;width:max-content;max-width:calc(100% - 48px)}.displayWrap .table{font-size:22px;margin-top:8px;margin-bottom:20px}.displayWrap .table th,.displayWrap .table td{padding:16px 12px}.displayWrap .distRow{grid-template-columns:240px 170px 1fr;gap:20px;font-size:22px;margin:18px 0}.displayWrap .barTrack{height:40px}.displayWrap .item{width:min(100%,980px);padding:34px;margin-top:12px}.resultCard{display:flex;align-items:center;justify-content:center;text-align:center}.resultContent{justify-content:center;padding-bottom:clamp(120px,12vh,170px)}.displayWrap .resultQuestion{max-width:1040px;margin-left:auto;margin-right:auto;margin-bottom:10px;font-size:clamp(40px,4.6vw,72px);line-height:1.12}.displayWrap .medal{font-size:92px}.displayWrap .reveal{min-height:520px}.displayWrap .reveal .medal{font-size:160px}.displayWrap .reveal .podiumName{font-size:clamp(72px,9vw,140px)}.displayWrap .podiumName{font-size:clamp(42px,5vw,82px)}.displayWrap .podium{gap:26px;margin-bottom:64px}.displayWrap .podiumCard{padding:40px 30px;border-radius:28px}.displayWrap .podiumCard.first{min-height:440px}.displayWrap .podiumCard.second{min-height:320px}.displayWrap .podiumCard.third{min-height:255px}.displayWrap .podiumCard.second .medal{font-size:68px}.displayWrap .podiumCard.third .medal{font-size:58px}.displayWrap .podiumCard.second h2{font-size:clamp(28px,3vw,42px)}.displayWrap .podiumCard.third h2{font-size:clamp(24px,2.6vw,36px)}.displayWrap .podiumCard.second .podiumName{font-size:clamp(34px,4vw,60px)}.displayWrap .podiumCard.third .podiumName{font-size:clamp(30px,3.4vw,52px)}
.confettiLayer{position:absolute;inset:0;z-index:4;pointer-events:none;overflow:hidden;border-radius:30px;animation:confettiLayerFade 3s ease forwards}.confettiPiece{position:absolute;top:-40px;width:12px;height:18px;border-radius:4px;opacity:.95;animation:confettiFall 2.8s cubic-bezier(.18,.72,.28,1) forwards}.confettiPiece:nth-child(3n){width:10px;height:10px;border-radius:50%}.confettiPiece:nth-child(4n){width:16px;height:8px}.confettiPiece:nth-child(5n){height:24px}@keyframes confettiFall{0%{transform:translate3d(0,-40px,0) rotate(0deg)}100%{transform:translate3d(var(--drift),900px,0) rotate(760deg)}}@keyframes confettiLayerFade{0%,72%{opacity:1}100%{opacity:0}}
.fullscreenBtn,.themeBtn{position:fixed;top:22px;z-index:20;width:42px;height:42px;border:1px solid rgba(210,210,215,.8);border-radius:50%;background:rgba(255,255,255,.82);color:var(--ink);font-size:21px;font-weight:700;display:grid;place-items:center;cursor:pointer;box-shadow:0 10px 28px rgba(0,0,0,.08);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}.fullscreenBtn{right:24px}.themeBtn{right:76px;font-size:18px}.fullscreenBtn:hover,.themeBtn:hover{background:#FFFFFF}body.darkMode{background:#0B0B0F;color:#F5F5F7}body.darkMode .displayCard,body.darkMode .card,body.darkMode .item{background:#1C1C1E;border-color:#3A3A3C;box-shadow:0 22px 70px rgba(0,0,0,.42)}body.darkMode h1,body.darkMode h2,body.darkMode h3,body.darkMode .podiumName{color:#F5F5F7}body.darkMode .sub,body.darkMode .muted,body.darkMode .table th{color:#A1A1A6}body.darkMode .brand{color:#A1A1A6}body.darkMode .pill{background:#2C2C2E;border-color:#48484A;color:#F5F5F7}body.darkMode .btn.ghost{background:#2C2C2E;color:#F5F5F7}body.darkMode .btn.ghost:hover{background:#3A3A3C}body.darkMode .barTrack{background:#2C2C2E;border-color:#48484A}body.darkMode .table th,body.darkMode .table td{border-bottom-color:#3A3A3C}body.darkMode .teamChip{background:#2C2C2E;border-color:#48484A;color:#F5F5F7}body.darkMode .answerCard{background:#17351F;border-color:#2E7D40}body.darkMode .answerCardValue{color:#F5F5F7}body.darkMode .podiumCard{background:#D1D1D6;color:#1D1D1F;border-color:#AEAEB2}body.darkMode .podiumCard h2,body.darkMode .podiumCard .podiumName,body.darkMode .podiumCard .big{color:#1D1D1F}body.darkMode .podiumCard.first{background:#FFFFFF;color:#1D1D1F;border-color:#D2D2D7}body.darkMode .podiumCard.first h2,body.darkMode .podiumCard.first .podiumName,body.darkMode .podiumCard.first .big{color:#1D1D1F}body.darkMode .fullscreenBtn,body.darkMode .themeBtn{background:rgba(44,44,46,.86);border-color:#48484A;color:#F5F5F7}body.darkMode .fullscreenBtn:hover,body.darkMode .themeBtn:hover{background:#3A3A3C}
.adminPage{background:var(--bg);color:var(--ink)}.adminPage .hero{padding:38px 0 30px;text-align:center}.adminPage .hero .brand{justify-content:center}.adminPage .sub{margin-left:auto;margin-right:auto;font-size:17px}.adminPage .card{border-radius:26px;padding:30px}.adminPage #login{width:min(100%,760px);margin:36px auto 0;padding:42px}.adminPage #login h2{font-size:32px}.adminPage #login input{min-height:58px;font-size:17px}.adminPage #login .btn{margin-top:18px;font-size:16px;padding:15px 24px}.adminTopCard{display:flex;align-items:center;justify-content:space-between;gap:28px}.adminTopCard p{margin:0}.adminLayout{display:grid;grid-template-columns:minmax(340px,430px) 1fr;gap:30px;align-items:start;margin-top:30px}.adminActions{display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin-top:26px}.adminQuestion{padding:22px 22px 20px;margin-top:22px;border-radius:20px;background:#FBFBFD}.adminQuestion:first-of-type{margin-top:0}.adminQuestion .row{margin-top:20px}.adminQuestion .btn.alt{background:#E8F2FF;color:#0066CC}.adminQuestion .btn.alt:hover{background:#DCEBFF}.adminResetCard{margin-top:22px;padding:22px}.adminResetCard h3{margin-bottom:8px}.adminResetCard .btn{margin-top:12px}.adminResetHint{max-width:340px;font-size:13px;margin-top:16px}
.participantPage #intro{text-align:center}.participantPage #intro .sub{margin-left:auto;margin-right:auto}
@media(min-width:861px){.participantPage .wrap.narrow{width:min(100% - 80px,1100px);max-width:1100px;min-height:100dvh;display:flex;flex-direction:column;justify-content:center}.participantPage #intro{padding-top:0;text-align:center}.participantPage #intro h1{font-size:clamp(72px,6vw,112px);line-height:1.02}.participantPage #intro .sub{font-size:24px;max-width:900px;margin-left:auto;margin-right:auto}.participantPage #join{margin-top:42px;padding:46px;border-radius:30px}.participantPage #join h2{font-size:36px}.participantPage #join label{font-size:16px}.participantPage #join input{min-height:64px;font-size:20px}.participantPage #join .btn{font-size:18px;padding:16px 26px}}
...
<div class="wrap narrow">
  ...
  <section id="join" class="card"><h2>Welches Tier seid ihr?</h2><input id="teamLabel" maxlength="80" autocomplete="off" placeholder="z. B. Löwe oder Giraffe"><button class="btn alt" id="joinBtn">Los geht's</button></section>
...
function confettiLayer(){var colors=["#0071E3","#34C759","#FF3B30","#FFCC00","#AF52DE","#FF9500"],layer=el("div","confettiLayer");for(var i=0;i<70;i++){var p=el("span","confettiPiece");p.style.left=(Math.random()*100)+"%";p.style.background=colors[i%colors.length];p.style.animationDelay=(Math.random()*0.55)+"s";p.style.setProperty("--drift",(Math.random()*220-110)+"px");layer.appendChild(p)}return layer}
function fireConfetti(){var card=document.querySelector(".displayCard");if(card)card.appendChild(confettiLayer())}
function podiumSlide(){var card=el("div","card screen displayCard"),inner=el("div");inner.style.width="100%";var titles=["Jetzt kommt die Siegerehrung","Platz 3","Platz 2","Platz 1","Unsere Gewinnerteams"];if(podiumStep>=4)card.appendChild(confettiLayer());inner.appendChild(el("h1","",titles[podiumStep]||titles[0]));if(podiumStep===0)inner.appendChild(el("p","sub","Gleich enthüllen wir die Top 3."));if(podiumStep===1)inner.appendChild(revealPlace(3));if(podiumStep===2)inner.appendChild(revealPlace(2));if(podiumStep===3)inner.appendChild(revealPlace(1));if(podiumStep>=4){inner.appendChild(podiumView(state.podium));inner.appendChild(table(["Platz","Team/Symbol","Punkte"],state.leaderboard.map(function(r){return["#"+r.rank,r.teamLabel,String(r.score)]})))}var nav=el("div","row displayActions");if(podiumStep>0){var cannon=el("button","btn ghost","🎉");cannon.title="Konfetti";cannon.onclick=fireConfetti;nav.appendChild(cannon)}if(podiumStep>0){var back=el("button","btn ghost","Zurück");back.onclick=function(){podiumStep--;render()};nav.appendChild(back)}if(podiumStep<4){var next=el("button","btn alt","Weiter");next.onclick=function(){podiumStep++;render()};nav.appendChild(next)}else{var toResults=el("button","btn ghost","Zurück zur Auflösung");toResults.onclick=function(){displayView="results";render()};nav.appendChild(toResults)}inner.appendChild(nav);card.appendChild(inner);return card}
...
function applyTheme(){var btn=qs("#themeBtn");if(!btn){document.body.classList.remove("darkMode");return}var dark=localStorage.getItem("schaetzquizDarkMode")==="1";document.body.classList.toggle("darkMode",dark);btn.textContent=dark?"☀":"☾";btn.title=dark?"Light Mode":"Dark Mode"}
function toggleTheme(){var dark=localStorage.getItem("schaetzquizDarkMode")==="1";localStorage.setItem("schaetzquizDarkMode",dark?"0":"1");applyTheme()}
...
<body>
<button id="themeBtn" class="themeBtn" title="Dark Mode" onclick="toggleTheme()">☾</button>
