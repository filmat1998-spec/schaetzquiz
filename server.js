...
function applyTheme(){var dark=localStorage.getItem("schaetzquizDarkMode")==="1";document.body.classList.toggle("darkMode",dark);var btn=qs("#themeBtn");if(btn){btn.textContent=dark?"☀":"☾";btn.title=dark?"Light Mode":"Dark Mode"}}
